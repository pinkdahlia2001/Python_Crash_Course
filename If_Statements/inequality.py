# (!=) can be used to determine whether two signs are not equal.
# ! represents not a.k.a not equal.

requested_topping = "mushrooms"
if requested_topping != "anchovies": # if requested_topping is NOT equal to anchovies, then print....
